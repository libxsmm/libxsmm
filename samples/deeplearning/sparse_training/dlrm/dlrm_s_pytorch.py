...
if __name__ == "__main__":
    ...
    parser.add_argument("--prune-type", choices=["random", "magnitude"])

    args = parser.parse_args()

    # Generate experiment name
    exp_name = "ts_{:.3f}_st_{}_en_{}_pt_{}".format(args.target_sparsity, args.start_step, args.end_step, args.prune_type)
        ...
        while k < args.nepochs:
            ...
            for j, (X, lS_o, lS_i, T) in enumerate(train_ld):
                ...
                if should_test and not args.inference_only:
                    ...
                    writer.add_scalar('te_auc', validation_results['roc_auc'], j)
                    # Uncomment the line below to print out the total time with overhead
