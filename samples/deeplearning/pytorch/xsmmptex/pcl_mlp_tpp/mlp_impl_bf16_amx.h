...
typedef struct my_fc_fwd_config_bf16_amx {
  libxsmm_blasint N;
  libxsmm_blasint C;
  libxsmm_blasint K;
  libxsmm_blasint bn;
...
#endif
} my_fc_fwd_config_bf16_amx;

typedef struct my_fc_bwd_config_bf16_amx {
  libxsmm_blasint N;
  libxsmm_blasint C;
  libxsmm_blasint K;
  libxsmm_blasint bn;
  ...
  float           lr;
} my_fc_bwd_config_bf16_amx;


my_fc_fwd_config_bf16_amx setup_my_fc_fwd_bf16_amx(libxsmm_blasint N, libxsmm_blasint C, libxsmm_blasint K, libxsmm_blasint bn,
                                                   libxsmm_blasint bc, libxsmm_blasint bk, libxsmm_blasint threads, my_eltwise_fuse fuse_type) {
  my_fc_fwd_config_bf16_amx res;
...
my_fc_bwd_config_bf16_amx setup_my_fc_bwd_bf16_amx(libxsmm_blasint N, libxsmm_blasint C, libxsmm_blasint K, libxsmm_blasint bn,
                                 libxsmm_blasint bc, libxsmm_blasint bk, libxsmm_blasint threads, my_eltwise_fuse fuse_type)
{
  my_fc_bwd_config_bf16_amx res;
  libxsmm_blasint lda = bk;
  libxsmm_blasint ldb = bc;
  libxsmm_blasint ldc = bk;
...
#ifdef FUSE_ACT_TRANS_FWD
void my_fc_fwd_exec_bf16_amx( my_fc_fwd_config_bf16_amx cfg, const libxsmm_bfloat16* wt_ptr, const libxsmm_bfloat16* in_act_ptr, libxsmm_bfloat16* out_act_ptr,
...
#else
void my_fc_bwd_exec_bf16_amx( my_fc_bwd_config_bf16_amx cfg,  libxsmm_bfloat16* wt_ptr, libxsmm_bfloat16* din_act_ptr,
                     const libxsmm_bfloat16* dout_act_ptr, libxsmm_bfloat16* dwt_ptr, const libxsmm_bfloat16* in_act_ptr,
