...
int main(int argc, char* argv[])
{
  ...
  /* Read in input data */
  char *train_image_path = "../common/mnist_data/train-images.idx3-ubyte";
  char *train_label_path = "../common/mnist_data/train-labels.idx1-ubyte";
  char *test_image_path = "../common/mnist_data/t10k-images.idx3-ubyte";
  char *test_label_path = "../common/mnist_data/t10k-labels.idx1-ubyte";
