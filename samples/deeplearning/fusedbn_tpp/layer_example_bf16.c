...
#   pragma omp parallel
#endif
    {
      ...
      const int tid = 0;
#endif
      my_bn_fwd_exec_bf16( my_bn_fwd, eqn_inp, eqn_inp_add, gamma, beta, eqn_mean, eqn_var, eqn_out, eqn_relumask, eps, 0, tid, scratch, (my_bn_norm_type)norm_type );
    }
...
#   pragma omp parallel
#endif
    {
      ...
      my_bn_bwd_exec_bf16( my_bn_bwd, eqn_dout, eqn_inp, naive_mean, naive_var, gamma, relumask, eqn_dinp, eqn_dinp_add, eqn_dgamma, eqn_dbeta, eps, 0, tid, scratch, (my_bn_norm_type)norm_type );
    }
