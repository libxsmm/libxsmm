            ...
            for TRA in 0 1; do
              for TRB in 0 1; do
                for STACK in 0; do
                  ...
                  # loading A in VNNI layout is mandatory for select precision
                  if [[ ( "$PREC" == 'BF8_BF16_F32_F32' || "$PREC" == 'BF8_BF16_F32_BF16' || "$PREC" == 'HF8_BF16_F32_F32' || "$PREC" == 'HF8_BF16_F32_BF16' || "$PREC" == 'MXFP4_BF16_F32_F32' || "$PREC" == 'MXFP4_BF16_F32_BF16' || "$PREC" == 'MXFP4_I8_I32_F32' || "$PREC" == 'MXFP4_I8_I32_BF16' || "$PREC" == 'MXFP4_F32_F32_F32' || "$PREC" == 'MXBF8_MXBF8_F32_F32' || "$PREC" == 'MXHF8_MXHF8_F32_F32' || "$PREC" == 'MXBF6_MXBF6_F32_F32' || "$PREC" == 'MXHF6_MXHF6_F32_F32' || "$PREC" == 'MXBF6_MXHF6_F32_F32' || "$PREC" == 'MXHF6_MXBF6_F32_F32' || "$PREC" == 'MXFP4_MXFP4_F32_F32' || "$PREC" == 'MXBF8_MXBF8_F32_MXBF8' || "$PREC" == 'MXFP4_MXFP4_F32_MXFP4' ) && ( "$AVNNI" == '0' ) ]]; then
                    continue
                  fi
                  ...
                  if [[ ( (("$PREC" == 'F16_F16_F32_F32' || "$PREC" == 'F16_F16_F32_F16') && ("$AVNNI" == '1' )) || "$PREC" == 'I16_I16_I32_I32' || "$PREC" == 'U8_I8_I32_I32' || "$PREC" == 'I8_U8_I32_I32' || "$PREC" == 'U8_U8_I32_I32' || "$PREC" == 'I8_I8_I32_I32' || "$PREC" == 'U4_U8_I32_I32' || "$PREC" == 'I2_U8_I32_I32' || "$PREC" == 'I2_I8_I32_I32' || "$PREC" == 'I1_U8_I32_I32' || "$PREC" == 'I1_I8_I32_I32' || "$PREC" == 'U8_I8_I32_F32' || "$PREC" == 'I8_U8_I32_F32' || "$PREC" == 'U8_U8_I32_F32' || "$PREC" == 'I8_I8_I32_F32' || "$PREC" == 'I8_BF16_F32_F32' || "$PREC" == 'I8_BF16_F32_BF16' || "$PREC" == 'U8_BF16_F32_F32' || "$PREC" == 'U8_BF16_F32_BF16' || "$PREC" == 'BF8_BF16_F32_F32' || "$PREC" == 'BF8_BF16_F32_BF16' || "$PREC" == 'HF8_BF16_F32_F32' || "$PREC" == 'HF8_BF16_F32_BF16' || "$PREC" == 'MXFP4_BF16_F32_F32' || "$PREC" == 'MXFP4_BF16_F32_BF16' || "$PREC" == 'MXFP4_I8_I32_F32' || "$PREC" == 'MXFP4_I8_I32_BF16' || "$PREC" == 'MXFP4_F32_F32_F32' || "$PREC" == 'MXBF8_MXBF8_F32_F32' || "$PREC" == 'MXHF8_MXHF8_F32_F32' || "$PREC" == 'MXBF6_MXBF6_F32_F32' || "$PREC" == 'MXHF6_MXHF6_F32_F32' || "$PREC" == 'MXBF6_MXHF6_F32_F32' || "$PREC" == 'MXHF6_MXBF6_F32_F32' || "$PREC" == 'MXFP4_MXFP4_F32_F32' || "$PREC" == 'MXBF8_MXBF8_F32_MXBF8' || "$PREC" == 'MXFP4_MXFP4_F32_MXFP4' ) && ( "$TRA" == '1'  ||  "$TRB" == '1') ]]; then
                    continue
                  fi
                  ...
                  if [[ ( "$PREC" == 'MXBF8_MXBF8_F32_F32' || "$PREC" == 'MXHF8_MXHF8_F32_F32' || "$PREC" == 'MXBF6_MXBF6_F32_F32' || "$PREC" == 'MXHF6_MXHF6_F32_F32' || "$PREC" == 'MXBF6_MXHF6_F32_F32' || "$PREC" == 'MXHF6_MXBF6_F32_F32' || "$PREC" == 'MXFP4_MXFP4_F32_F32' || "$PREC" == 'MXBF8_MXBF8_F32_MXBF8' || "$PREC" == 'MXFP4_MXFP4_F32_MXFP4' ) && ("$UNARY_POSTOP" == '0') && ("$BINARY_POSTOP" == '0') ]] ; then
                    if [[ ( "$TRA" == '0' ) && ( "$TRB" == '0' ) && ( "$AVNNI" == '1' ) ]] ; then
                  ...
                  if [[ ( "$PREC" == 'MXBF8_MXBF8_F32_F32' || "$PREC" == 'MXHF8_MXHF8_F32_F32' || "$PREC" == 'MXBF6_MXBF6_F32_F32' || "$PREC" == 'MXHF6_MXHF6_F32_F32' || "$PREC" == 'MXBF6_MXHF6_F32_F32' || "$PREC" == 'MXHF6_MXBF6_F32_F32' || "$PREC" == 'MXFP4_MXFP4_F32_F32' || "$PREC" == 'MXBF8_MXBF8_F32_MXBF8' || "$PREC" == 'MXFP4_MXFP4_F32_MXFP4' ) ]] ; then
                    rm -f ${HERE}/${OUTNAME}
                    continue
                  fi
