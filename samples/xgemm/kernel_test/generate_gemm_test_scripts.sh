              ...
              for TRA in 0 1; do
                for TRB in 0 1; do
                  for STACK in 0 1; do
                    ...
                    # loading A in VNNI layout is mandatory for select precision
                    if [[ ( "$PREC" == 'BF8_BF16_F32_F32' || "$PREC" == 'BF8_BF16_F32_BF16' || "$PREC" == 'HF8_BF16_F32_F32' || "$PREC" == 'HF8_BF16_F32_BF16' || "$PREC" == 'MXFP4_BF16_F32_F32' || "$PREC" == 'MXFP4_BF16_F32_BF16' || "$PREC" == 'MXFP4_F32_F32_F32' ) && ( "$AVNNI" == '0' ) ]]; then
                      continue
                    fi
                    ...
                    if [[ ( "$PREC" == 'MXFP4_BF16_F32_BF16' || "$PREC" == 'MXFP4_BF16_F32_F32' || "$PREC" == 'MXFP4_F32_F32_F32' ) ]] ; then
