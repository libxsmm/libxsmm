...
./kernel_fused ${TESTFILE1} 1 1 0 0 ${TRA} ${TRB} ${PREC} addrbr 5 0 1 1 0 ${BINARY_POSTOP} ${UNARY_POSTOP} ${CVNNI}

./kernel_fused ${TESTFILE1} 1 1 0 0 ${TRA} ${TRB} ${PREC} offsbr 5 0 1 1 0 ${BINARY_POSTOP} ${UNARY_POSTOP} ${CVNNI}

./kernel_fused ${TESTFILE1} 1 1 0 0 ${TRA} ${TRB} ${PREC} strdbr 5 0 1 1 0 ${BINARY_POSTOP} ${UNARY_POSTOP} ${CVNNI}
