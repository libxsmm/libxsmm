...
inline void vectorized_softmax_fwd_bf16(long S1, long S2, long S3, libxsmm_bfloat16 *pinp, libxsmm_bfloat16 *pout) {
  int s1, s2, s3;
...
inline void vectorized_softmax_bwd_bf16(long S1, long S2, long S3, float *pgradinp, float *pgradout, libxsmm_bfloat16 *pout) {
  int s1, s2, s3;
...
inline void vectorized_softmax_fwd(long S1, long S2, long S3, float *pinp, float *pout) {
  int s1, s2, s3;
...
inline void vectorized_softmax_bwd(long S1, long S2, long S3, float *pgradinp, float *pgradout, float *pout) {
  int s1, s2, s3;
  LIBXSMM_VLA_DECL(3, float, ginp, pgradinp, S2, S3);
  LIBXSMM_VLA_DECL(3, float, gout, pgradout, S2, S3);
  LIBXSMM_VLA_DECL(3, float, out, pout, S2, S3);
...
int main( int argc, char* argv[] ) {
  ...
  float *inp, *out, *eqn_out, *arg_array[1], *gout;
