...
int main( /*int argc, char* argv[]*/ ) {
  ...
  test_evex_compute_mem_2reg_general( "evex_mem_VPUNPCKLBW", &mycode, LIBXSMM_X86_INSTR_VPUNPCKLBW, 2, LIBXSMM_X86_IMM_UNDEF, 32, 0 );
  test_evex_compute_mem_2reg_general( "evex_mem_VPUNPCKHBW", &mycode, LIBXSMM_X86_INSTR_VPUNPCKHBW, 2, LIBXSMM_X86_IMM_UNDEF, 32, 0 );
