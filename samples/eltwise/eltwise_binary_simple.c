...
int main( int argc, char* argv[] ) {
  ...
  if ( argc != 11 ) {
    printf(" Error! Usage: %s [type] [use_bcast: 0/1/2/3/4/5/6] [prec_in0: F32/BF16/BF8/HF8] [prec_in1: F32/BF16/BF8/HF8] [compute_prec: F32] [prec_out: F32/BF16/BF8/HF8] [M] [N] [ldi] [ldo]\n", argv[0] );
    exit(-1);
  }
