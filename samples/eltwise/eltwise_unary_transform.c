...
int main( int argc, char* argv[] ) {
  ...
  if ( op == 'T' && dtype == 8 ) {
    ...
    printf(" Not implemented case! Usage: %s [T/V/R/N/W/X/Y/Z] [8/4/2/1] [M] [N] [ldi] [ldo]\n", argv[0] );
    exit(-1);
  }
