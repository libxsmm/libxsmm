...
int main( int argc, char* argv[] ) {
  ...
  if ( argc != 7 ) {
    printf(" Error! Usage: %s [T/V/R/X/Y/Z/B] [F64/I64/F32/I32/BF16/F16/I16/BF8/I8] [M] [N] [ldi] [ldo]\n", argv[0] );
    exit(-1);
  }
  ...
  if ( op == 'T' ) {
    ...
    printf(" Not implemented case! Usage: %s [T/V/R/N/W/X/Y/Z/B] [F64/I64/F32/I32/BF16/F16/I16/BF8/I8] [M] [N] [ldi] [ldo]\n", argv[0] );
    exit(-1);
  }
