...
SRCFILES_LIB := $(patsubst %,$(ROOTSRC)/%, \
          ...
          libxsmm_rng.c libxsmm_mhd.c generator_gemm_reference_impl.c generator_mateltwise_reference_impl.c generator_matequation_reference_impl.c generator_x86_reference.c generator_aarch64_reference.c generator_ppc64le_reference.c generator_rv64_reference.c)
