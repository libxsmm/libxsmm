...
#define LIBXSMM_TYPESIZE(ENUM) ( \
  ...
  (LIBXSMM_DATATYPE_NVFP4X2 == ((int)(ENUM))) ? 1 : ( \
...
#  define LIBXSMM_GETENUM_SIGNED_DATATYPE(SRC) ( \
  ...
  (LIBXSMM_DATATYPE_HF8         == (SRC)) ? LIBXSMM_DATATYPE_HF8 : ( \
  (LIBXSMM_DATATYPE_I64         == (SRC)) ? LIBXSMM_DATATYPE_I64 : ( \
  (LIBXSMM_DATATYPE_U64         == (SRC)) ? LIBXSMM_DATATYPE_I64 : ( \
  (LIBXSMM_DATATYPE_I32         == (SRC)) ? LIBXSMM_DATATYPE_I32 : ( \
  (LIBXSMM_DATATYPE_U32         == (SRC)) ? LIBXSMM_DATATYPE_I32 : ( \
  (LIBXSMM_DATATYPE_I16         == (SRC)) ? LIBXSMM_DATATYPE_I16 : ( \
  (LIBXSMM_DATATYPE_U16         == (SRC)) ? LIBXSMM_DATATYPE_I16 : ( \
  ...
  (LIBXSMM_DATATYPE_NVFP4X2     == (SRC)) ? LIBXSMM_DATATYPE_NVFP4X2 : ( \
...
typedef enum libxsmm_gemm_flags {
  ...
  LIBXSMM_GEMM_FLAG_ALIGN_C_NTS_HINT_BETA_0_BATCH_REDUCE_ADDRESS = LIBXSMM_GEMM_FLAG_BETA_0 | LIBXSMM_GEMM_FLAG_ALIGN_C_NTS_HINT |
                                                                   LIBXSMM_GEMM_FLAG_BATCH_REDUCE_ADDRESS,
  LIBXSMM_GEMM_FLAG_ALIGN_C_NTS_HINT_BATCH_REDUCE_OFFSET = LIBXSMM_GEMM_FLAG_BATCH_REDUCE_OFFSET |
                                                           LIBXSMM_GEMM_FLAG_ALIGN_C_NTS_HINT,
  LIBXSMM_GEMM_FLAG_ALIGN_C_NTS_HINT_BETA_0_BATCH_REDUCE_OFFSET = LIBXSMM_GEMM_FLAG_BETA_0 | LIBXSMM_GEMM_FLAG_ALIGN_C_NTS_HINT |
                                                                  LIBXSMM_GEMM_FLAG_BATCH_REDUCE_OFFSET,
  LIBXSMM_GEMM_FLAG_ALIGN_C_NTS_HINT_BATCH_REDUCE_STRIDE = LIBXSMM_GEMM_FLAG_BATCH_REDUCE_STRIDE |
                                                           LIBXSMM_GEMM_FLAG_ALIGN_C_NTS_HINT,
