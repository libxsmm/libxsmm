...
typedef enum libxsmm_meltw_operation {
  ...
  LIBXSMM_MELTW_OPERATION_DECOMPRESS_A_SPARSITY_FACTOR_2  = 13,
  LIBXSMM_MELTW_OPERATION_DECOMPRESS_A_SPARSITY_FACTOR_4  = 14,
  LIBXSMM_MELTW_OPERATION_DECOMPRESS_A_SPARSITY_FACTOR_8  = 15,
  LIBXSMM_MELTW_OPERATION_DECOMPRESS_A_SPARSITY_FACTOR_16 = 16,
  LIBXSMM_MELTW_OPERATION_DECOMPRESS_A_SPARSITY_FACTOR_32 = 17,
  LIBXSMM_MELTW_OPERATION_COLBIAS_ACT_DECOMPRESS_A_SPARSITY_FACTOR_2  = 18,
  LIBXSMM_MELTW_OPERATION_COLBIAS_ACT_DECOMPRESS_A_SPARSITY_FACTOR_4  = 19,
  LIBXSMM_MELTW_OPERATION_COLBIAS_ACT_DECOMPRESS_A_SPARSITY_FACTOR_8  = 20,
  LIBXSMM_MELTW_OPERATION_COLBIAS_ACT_DECOMPRESS_A_SPARSITY_FACTOR_16 = 21,
  LIBXSMM_MELTW_OPERATION_COLBIAS_ACT_DECOMPRESS_A_SPARSITY_FACTOR_32 = 22
