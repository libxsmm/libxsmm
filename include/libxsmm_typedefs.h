...
#define LIBXSMM_GETENUM_INP(SRC) ( \
  ...
  (LIBXSMM_DATATYPE_U32         == LIBXSMM_GETENUM_UNP(SRC)) ? LIBXSMM_DATATYPE_U32 : ( \
  (LIBXSMM_DATATYPE_I16         == LIBXSMM_GETENUM_UNP(SRC)) ? LIBXSMM_DATATYPE_I16 : ( \
  (LIBXSMM_DATATYPE_U16         == LIBXSMM_GETENUM_UNP(SRC)) ? LIBXSMM_DATATYPE_U16 : ( \
...
typedef enum libxsmm_meltw_binary_type {
  ...
  LIBXSMM_MELTW_TYPE_BINARY_ZIP                          =  8,
