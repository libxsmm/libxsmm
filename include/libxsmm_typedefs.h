...
typedef enum libxsmm_gemm_flags {
  ...
  LIBXSMM_GEMM_FLAG_INTERPRETE_A_AS_MXFP4_VNNI2_INTLV = 1073741824,
  LIBXSMM_GEMM_FLAG_INTERPRETE_B_AS_MXFP4_VNNI2_INTLV = 536870912,
  /* combined types */
  ...
  LIBXSMM_GEMM_FLAG_ALIGN_C_NTS_HINT_BETA_0_BATCH_REDUCE_STRIDE_AB_UNSIGNED = LIBXSMM_GEMM_FLAG_BETA_0 |
                                                                              ...
                                                                              LIBXSMM_GEMM_FLAG_AB_UNSIGNED,
  /** Marker flag; do not use. */
  LIBXSMM_GEMM_FLAG_INVALID = 2147483648
} libxsmm_gemm_flags;
