...
typedef enum libxsmm_meltw_unary_flags {
  ...
  LIBXSMM_MELTW_TYPE_UNARY_BCAST_ROW    = 2,
  LIBXSMM_MELTW_TYPE_UNARY_BCAST_COL    = 4,
  LIBXSMM_MELTW_TYPE_UNARY_BCAST_SCALAR = 8
...
typedef enum libxsmm_meltw_binary_flags {
  ...
  LIBXSMM_MELTW_TYPE_BINARY_BCAST_ROW_IN_0    = 1,
  LIBXSMM_MELTW_TYPE_BINARY_BCAST_ROW_IN_1    = 2,
  LIBXSMM_MELTW_TYPE_BINARY_BCAST_COL_IN_0    = 4,
  LIBXSMM_MELTW_TYPE_BINARY_BCAST_COL_IN_1    = 8,
  LIBXSMM_MELTW_TYPE_BINARY_BCAST_SCALAR_IN_0 = 16,
  LIBXSMM_MELTW_TYPE_BINARY_BCAST_SCALAR_IN_1 = 32
