...
typedef enum libxsmm_meltw_unary_flags {
  ...
  LIBXSMM_MELTW_FLAG_UNARY_REDUCE_NEG_INF_ACC = 512,
  LIBXSMM_MELTW_FLAG_UNARY_REDUCE_POS_INF_ACC = 1024,
  LIBXSMM_MELTW_FLAG_UNARY_REDUCE_NO_PREFETCH = 2048,
  LIBXSMM_MELTW_FLAG_UNARY_REDUCE_RECORD_ARGOP= 4096,
  LIBXSMM_MELTW_FLAG_UNARY_STOCHASTIC_ROUND   = 8192,
  LIBXSMM_MELTW_FLAG_UNARY_GS_ROWS            = 16384,
  LIBXSMM_MELTW_FLAG_UNARY_GS_COLS            = 32768,
  LIBXSMM_MELTW_FLAG_UNARY_GS_OFFS            = 65536
...
typedef enum libxsmm_gemm_flags {
  ...
  LIBXSMM_GEMM_FLAG_INTERPRETE_A_AS_INT4_VNNI2 = 1048576,
  /* combined types */
  ...
  /** Marker flag; do not use. */
  LIBXSMM_GEMM_FLAG_INVALID = 2097152
} libxsmm_gemm_flags;
