...
#   define LIBXSMM_API        LIBXSMM_EXTERN   LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
#   define LIBXSMM_API_INTERN LIBXSMM_EXTERN_C LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_PRIVATE
#   define LIBXSMM_API_EXPORT LIBXSMM_EXTERN   LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
#   define LIBXSMM_APIEXT     LIBXSMM_EXTERN_C LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_EXPORT
#   define LIBXSMM_APIEXT_INTERN LIBXSMM_API_INTERN
# elif defined(LIBXSMM_BUILD)
#   define LIBXSMM_API        LIBXSMM_EXTERN   LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_EXPORT
#   define LIBXSMM_API_INTERN LIBXSMM_EXTERN_C LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_PRIVATE
#   define LIBXSMM_API_EXPORT LIBXSMM_EXTERN   LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_EXPORT
#   define LIBXSMM_APIEXT     LIBXSMM_EXTERN   LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
# else /* import */
#   define LIBXSMM_API        LIBXSMM_EXTERN LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
#   define LIBXSMM_API_INTERN LIBXSMM_EXTERN LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
#   define LIBXSMM_API_EXPORT LIBXSMM_EXTERN LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
#   define LIBXSMM_APIEXT     LIBXSMM_EXTERN LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
# endif
