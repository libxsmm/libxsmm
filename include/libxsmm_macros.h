...
# define LIBXSMM_APIVAR_DEFINE(DECL) /* elide */
#else /* classic ABI */
# if defined(LIBXSMM_BUILD_EXT)
#   define LIBXSMM_API        LIBXSMM_EXTERN_C LIBXSMM_EXTERN_KEYWORD LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
#   define LIBXSMM_API_INTERN LIBXSMM_EXTERN_C                        LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_PRIVATE
#   define LIBXSMM_API_EXPORT LIBXSMM_EXTERN_C LIBXSMM_EXTERN_KEYWORD LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
#   define LIBXSMM_APIEXT     LIBXSMM_EXTERN_C                        LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_EXPORT
#   define LIBXSMM_APIEXT_INTERN LIBXSMM_API_INTERN
# elif defined(LIBXSMM_BUILD)
#   define LIBXSMM_API        LIBXSMM_EXTERN_C LIBXSMM_EXTERN_KEYWORD LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_EXPORT
#   define LIBXSMM_API_INTERN LIBXSMM_EXTERN_C                        LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_PRIVATE
#   define LIBXSMM_API_EXPORT LIBXSMM_EXTERN_C LIBXSMM_EXTERN_KEYWORD LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_EXPORT
#   define LIBXSMM_APIEXT     LIBXSMM_EXTERN_C LIBXSMM_EXTERN_KEYWORD LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
# else /* import */
#   define LIBXSMM_API        LIBXSMM_EXTERN_C LIBXSMM_EXTERN_KEYWORD LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
#   define LIBXSMM_API_INTERN LIBXSMM_EXTERN_C LIBXSMM_EXTERN_KEYWORD LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
#   define LIBXSMM_API_EXPORT LIBXSMM_EXTERN_C LIBXSMM_EXTERN_KEYWORD LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
#   define LIBXSMM_APIEXT     LIBXSMM_EXTERN_C LIBXSMM_EXTERN_KEYWORD LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_IMPORT
# endif
# define LIBXSMM_APIVAR_DEFINE(DECL) LIBXSMM_ALIGNED(LIBXSMM_EXTERN_C LIBXSMM_RETARGETABLE LIBXSMM_VISIBILITY_EXPORT DECL, LIBXSMM_CONFIG_CACHELINE);
# define LIBXSMM_APIVAR_PUBLIC(DECL) LIBXSMM_API DECL
# define LIBXSMM_APIVAR(DECL) LIBXSMM_API_INTERN DECL
#endif
#if !defined(_WIN32)
