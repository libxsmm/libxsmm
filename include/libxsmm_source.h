...
#include "../src/generator_gemm_s390x.c"
...
#include "../src/generator_gemm_vxrs_microkernel.c"
...
#include "../src/generator_s390x_instructions.c"
...
#include "../src/libxsmm_cpuid_s390x.c"
