...
* [Profiling using Linux&#160;perf](documentation/libxsmm_prof.md#linux-perf)
...
* [Customize performance](documentation/libxsmm_tune.md#tuning)
* <a name="Tuning auto-dispatch"></a>[Auto-dispatch](documentation/libxsmm_tune.md#auto-dispatch)
