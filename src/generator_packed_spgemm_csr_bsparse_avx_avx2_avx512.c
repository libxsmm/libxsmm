...
void libxsmm_generator_packed_spgemm_csr_bsparse_avx_avx2_avx512_kloop( libxsmm_generated_code*            io_generated_code,
  ...
  if ( i_packed_range/i_packed_blocking > 1 ) {
    ...
    /* packed loop footer */
    libxsmm_x86_instruction_alu_imm( io_generated_code, i_micro_kernel_config->alu_cmp_instruction, i_gp_reg_mapping->gp_reg_help_0,
      i_packed_range/i_packed_blocking );
