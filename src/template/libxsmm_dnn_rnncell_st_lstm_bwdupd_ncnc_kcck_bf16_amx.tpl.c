...
LIBXSMM_VLA_DECL(4, element_input_type,  cp, csp, kBlocks, bn, bk);
...
#endif
LIBXSMM_VLA_DECL(5, element_output_type, cs, cst, nBlocks, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(5, element_output_type, h, ht, nBlocks, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(5, element_output_type, i, it, nBlocks, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(5, element_output_type, f, ft, nBlocks, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(5, element_output_type, o, ot, nBlocks, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(5, element_output_type, ci, cit, nBlocks, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(5, element_output_type, co, cot, nBlocks, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(5, float,  dx, dxD, nBlocks, cBlocks, bn, bc);
LIBXSMM_VLA_DECL(5, element_input_type,  dx_bf16, dxt, nBlocks, cBlocks, bn, bc);
LIBXSMM_VLA_DECL(4, element_input_type,  dcp, dcsp, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(4, element_input_type,  dhp, dhpD, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(4, float,  dhp_f32, dhpD_f32, kBlocks, bn, bk);
...
LIBXSMM_VLA_DECL(4, element_output_type, dcs, dcsD, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(5, element_output_type, dh, dht, nBlocks, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(4, element_output_type, di, diD, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(4, element_output_type, df, dfD, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(4, element_output_type, dp, doD, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(4, element_output_type, dci, dciD, kBlocks, bn, bk);
...
LIBXSMM_VLA_DECL(4, float, dout, doutD, kBlocks, bn, bk);
LIBXSMM_VLA_DECL(4, element_input_type,  xT, scratch_xT, nBlocks, bc, bn);
...
LIBXSMM_VLA_DECL(4, element_output_type, hT, scratch_hT, nBlocks, bk, bn);
float *dout_ptr = NULL;
...
#include "libxsmm_dnn_rnncell_st_lstm_bwdupd_ncnc_kcck_core_bf16_amx.tpl.c"
