    ...
    for (im = 0; im < i_m_blocking; im++) {
      ...
      if ( bcast_input == 0) {
        ...
        if ( (LIBXSMM_DATATYPE_F32 == libxsmm_meltw_getenum_precision(i_mateltwise_desc, LIBXSMM_MELTW_FIELD_COMP) && LIBXSMM_DATATYPE_BF16 == libxsmm_meltw_getenum_precision(i_mateltwise_desc, LIBXSMM_MELTW_FIELD_IN0)) ||
          ...
          libxsmm_generator_cvtbf16ps_avx2_avx512( io_generated_code, 'z', cur_vreg, cur_vreg );
          ...
          libxsmm_generator_cvtbf8ps_avx512( io_generated_code, 'z', cur_vreg, cur_vreg );
        }
...
void libxsmm_store_2d_reg_block( libxsmm_generated_code*                 io_generated_code,
  ...
  char vname = (i_vlen * i_micro_kernel_config->datatype_size_out == 64) ? 'z' : (i_vlen * i_micro_kernel_config->datatype_size_out == 16)?'x':'y';
    ...
    for (im = 0; im < i_m_blocking; im++) {
      ...
      if ( (bcast_input == 0) ||
        ...
        if (LIBXSMM_DATATYPE_BF16 == libxsmm_meltw_getenum_precision( i_mateltwise_desc, LIBXSMM_MELTW_FIELD_IN1)) {
          ...
          libxsmm_generator_cvtbf16ps_avx2_avx512( io_generated_code, 'z', i_micro_kernel_config->tmp_vreg, i_micro_kernel_config->tmp_vreg );
          ...
          libxsmm_generator_cvtbf8ps_avx512( io_generated_code, 'z', i_micro_kernel_config->tmp_vreg, i_micro_kernel_config->tmp_vreg );
        } else {
          libxsmm_x86_instruction_unified_vec_move( io_generated_code,
            vmove_instr_in2,
            i_gp_reg_mapping->gp_reg_in2,
      ...
      if (i_mateltwise_desc->param == LIBXSMM_MELTW_TYPE_BINARY_MULADD) {
        if (LIBXSMM_DATATYPE_BF16 == libxsmm_meltw_getenum_precision(i_mateltwise_desc, LIBXSMM_MELTW_FIELD_OUT)) {
          ...
          libxsmm_generator_cvtbf16ps_avx2_avx512( io_generated_code, 'z', i_micro_kernel_config->tmp_vreg2, i_micro_kernel_config->tmp_vreg2 );
          ...
          libxsmm_generator_cvtbf8ps_avx512( io_generated_code, 'z', i_micro_kernel_config->tmp_vreg2, i_micro_kernel_config->tmp_vreg2 );
        } else {
          libxsmm_x86_instruction_unified_vec_move( io_generated_code,
            i_micro_kernel_config->vmove_instruction_in,
            i_gp_reg_mapping->gp_reg_out,
