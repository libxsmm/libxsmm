...
void libxsmm_configure_unary_kernel_vregs_masks( libxsmm_generated_code*                 io_generated_code,
  ...
  if (op == LIBXSMM_MELTW_TYPE_UNARY_GELU || op == LIBXSMM_MELTW_TYPE_UNARY_GELU_INV) {
    ...
    if (io_generated_code->arch < LIBXSMM_X86_AVX512_VL256) {
      ...
      i_micro_kernel_config->vec_c0_lo      = reserved_zmms - 12;
      i_micro_kernel_config->vec_c0_hi      = reserved_zmms - 13;
      i_micro_kernel_config->vec_c1_lo      = reserved_zmms - 14;
      i_micro_kernel_config->vec_c1_hi      = reserved_zmms - 15;
      i_micro_kernel_config->vec_c2_lo      = reserved_zmms - 16;
      i_micro_kernel_config->vec_c2_hi      = reserved_zmms - 17;
