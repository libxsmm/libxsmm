...
void libxsmm_generator_gemm_kernel( libxsmm_generated_code*        io_generated_code,
  ...
  if ( ( io_generated_code->arch >= LIBXSMM_S390X ) && (io_generated_code->arch <= LIBXSMM_S390X_ALLFEAT ) ) {
  ...
  } else if ( ( io_generated_code->arch >= LIBXSMM_S390X_Z15 ) && ( io_generated_code->arch <= LIBXSMM_S390X_ALLFEAT ) ) {
