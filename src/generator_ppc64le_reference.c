...
void libxsmm_generator_ppc64le_reference_kernel( libxsmm_generated_code *io_generated_code,
  ...
  libxsmm_ppc64le_used_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_sp_copy );
  l_arg1 = LIBXSMM_PPC64LE_GPR_ARG1;
  libxsmm_ppc64le_used_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_arg1 );
  ...
  libxsmm_ppc64le_instr_stack_alloc( io_generated_code, &l_reg_tracker, (long)( l_padded_desc_size + 32 ) );
  ...
  libxsmm_ppc64le_free_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_temp_reg );
  libxsmm_ppc64le_free_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, LIBXSMM_PPC64LE_GPR_ARG0 );
  libxsmm_ppc64le_free_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_arg1 );
...
void libxsmm_generator_matequation_ppc64le_reference_kernel( libxsmm_generated_code        *io_generated_code,
  ...
  l_arg1 = LIBXSMM_PPC64LE_GPR_ARG1;
  libxsmm_ppc64le_used_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_arg1 );
  l_arg2 = LIBXSMM_PPC64LE_GPR_ARG2;
  libxsmm_ppc64le_used_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_arg2 );
  l_arg3 = LIBXSMM_PPC64LE_GPR_ARG3;
  libxsmm_ppc64le_used_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_arg3 );
  ...
  /* Increament stack pointer to store description struct with back chain */
  libxsmm_ppc64le_instr_stack_alloc( io_generated_code, &l_reg_tracker, (long)( l_padded_size + 32 ) );
  ...
  libxsmm_ppc64le_instr_stack_alloc( io_generated_code, &l_reg_tracker, (long)( l_scratch_size + 32 ) );
  ...
  libxsmm_ppc64le_free_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_sp_copy );
  libxsmm_ppc64le_free_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_arg1 );
  libxsmm_ppc64le_free_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_arg2 );
  libxsmm_ppc64le_free_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_arg3 );
  libxsmm_ppc64le_free_reg( io_generated_code, &l_reg_tracker, LIBXSMM_PPC64LE_GPR, l_temp_reg );
