...
void smm_dnn_18_17_24(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb17 = _MM512_MASK_LOADU_PD(&b[289+0],255);
 xb18 = _MM512_MASK_LOADU_PD(&b[306+0],255);
 xb19 = _MM512_MASK_LOADU_PD(&b[323+0],255);
 xb20 = _MM512_MASK_LOADU_PD(&b[340+0],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[357+0],255);
 xb22 = _MM512_MASK_LOADU_PD(&b[374+0],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[391+0],255);
for(i=0;i<18;i+=1){
 ...
 xb17 = _MM512_MASK_LOADU_PD(&b[289+8],255);
 xb18 = _MM512_MASK_LOADU_PD(&b[306+8],255);
 xb19 = _MM512_MASK_LOADU_PD(&b[323+8],255);
 xb20 = _MM512_MASK_LOADU_PD(&b[340+8],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[357+8],255);
 xb22 = _MM512_MASK_LOADU_PD(&b[374+8],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[391+8],255);
for(i=0;i<18;i+=1){
 ...
 xb17 = _MM512_MASK_LOADU_PD(&b[289+16],1);
 xb18 = _MM512_MASK_LOADU_PD(&b[306+16],1);
 xb19 = _MM512_MASK_LOADU_PD(&b[323+16],1);
 xb20 = _MM512_MASK_LOADU_PD(&b[340+16],1);
 xb21 = _MM512_MASK_LOADU_PD(&b[357+16],1);
 xb22 = _MM512_MASK_LOADU_PD(&b[374+16],1);
 xb23 = _MM512_MASK_LOADU_PD(&b[391+16],1);
for(i=0;i<18;i+=1){
...
#else
printf("cppgemm_2_18_24_17\n");
for(int m=0;m<18;m++){
   for(int n=0;n<17;n++){
      for(int k=0;k<24;k++){
         c[m*17+n]+=a[m*24+k]*b[k*17+n];
      }
   }
}
#endif
