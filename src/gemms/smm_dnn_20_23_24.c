...
void smm_dnn_20_23_24(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb22 = _MM512_MASK_LOADU_PD(&b[506+0],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[529+0],255);
for(i=0;i<20;i+=1){
 ...
 xb22 = _MM512_MASK_LOADU_PD(&b[506+8],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[529+8],255);
for(i=0;i<20;i+=1){
 ...
 xb22 = _MM512_MASK_LOADU_PD(&b[506+16],127);
 xb23 = _MM512_MASK_LOADU_PD(&b[529+16],127);
for(i=0;i<20;i+=1){
...
#else
printf("cppgemm_2_20_24_23\n");
for(int m=0;m<20;m++){
   for(int n=0;n<23;n++){
      for(int k=0;k<24;k++){
         c[m*23+n]+=a[m*24+k]*b[k*23+n];
      }
   }
}
#endif
