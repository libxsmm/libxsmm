...
void smm_dnn_16_19_24(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb20 = _MM512_MASK_LOADU_PD(&b[380+0],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[399+0],255);
 xb22 = _MM512_MASK_LOADU_PD(&b[418+0],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[437+0],255);
for(i=0;i<16;i+=1){
 ...
 xb20 = _MM512_MASK_LOADU_PD(&b[380+8],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[399+8],255);
 xb22 = _MM512_MASK_LOADU_PD(&b[418+8],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[437+8],255);
for(i=0;i<16;i+=1){
 ...
 xb20 = _MM512_MASK_LOADU_PD(&b[380+16],7);
 xb21 = _MM512_MASK_LOADU_PD(&b[399+16],7);
 xb22 = _MM512_MASK_LOADU_PD(&b[418+16],7);
 xb23 = _MM512_MASK_LOADU_PD(&b[437+16],7);
for(i=0;i<16;i+=1){
...
#else
printf("cppgemm_2_16_24_19\n");
for(int m=0;m<16;m++){
   for(int n=0;n<19;n++){
      for(int k=0;k<24;k++){
         c[m*19+n]+=a[m*24+k]*b[k*19+n];
      }
   }
}
#endif
