...
void smm_dnn_12_10_24(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb23 = _MM512_MASK_LOADU_PD(&b[230+0],255);
for(i=0;i<12;i+=1){
 ...
 xb23 = _MM512_MASK_LOADU_PD(&b[230+8],3);
for(i=0;i<12;i+=1){
...
#else
printf("cppgemm_2_12_24_10\n");
for(int m=0;m<12;m++){
   for(int n=0;n<10;n++){
      for(int k=0;k<24;k++){
         c[m*10+n]+=a[m*24+k]*b[k*10+n];
      }
   }
}
#endif
