...
void smm_dnn_13_11_24(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb22 = _MM512_MASK_LOADU_PD(&b[242+0],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[253+0],255);
for(i=0;i<13;i+=1){
 ...
 xb22 = _MM512_MASK_LOADU_PD(&b[242+8],7);
 xb23 = _MM512_MASK_LOADU_PD(&b[253+8],7);
for(i=0;i<13;i+=1){
...
#else
printf("cppgemm_2_13_24_11\n");
for(int m=0;m<13;m++){
   for(int n=0;n<11;n++){
      for(int k=0;k<24;k++){
         c[m*11+n]+=a[m*24+k]*b[k*11+n];
      }
   }
}
#endif
