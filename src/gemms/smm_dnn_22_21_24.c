...
void smm_dnn_22_21_24(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb17 = _MM512_MASK_LOADU_PD(&b[357+0],255);
 xb18 = _MM512_MASK_LOADU_PD(&b[378+0],255);
 xb19 = _MM512_MASK_LOADU_PD(&b[399+0],255);
 xb20 = _MM512_MASK_LOADU_PD(&b[420+0],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[441+0],255);
 xb22 = _MM512_MASK_LOADU_PD(&b[462+0],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[483+0],255);
for(i=0;i<22;i+=1){
 ...
 xb17 = _MM512_MASK_LOADU_PD(&b[357+8],255);
 xb18 = _MM512_MASK_LOADU_PD(&b[378+8],255);
 xb19 = _MM512_MASK_LOADU_PD(&b[399+8],255);
 xb20 = _MM512_MASK_LOADU_PD(&b[420+8],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[441+8],255);
 xb22 = _MM512_MASK_LOADU_PD(&b[462+8],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[483+8],255);
for(i=0;i<22;i+=1){
 ...
 xb17 = _MM512_MASK_LOADU_PD(&b[357+16],31);
 xb18 = _MM512_MASK_LOADU_PD(&b[378+16],31);
 xb19 = _MM512_MASK_LOADU_PD(&b[399+16],31);
 xb20 = _MM512_MASK_LOADU_PD(&b[420+16],31);
 xb21 = _MM512_MASK_LOADU_PD(&b[441+16],31);
 xb22 = _MM512_MASK_LOADU_PD(&b[462+16],31);
 xb23 = _MM512_MASK_LOADU_PD(&b[483+16],31);
for(i=0;i<22;i+=1){
...
#else
printf("cppgemm_2_22_24_21\n");
for(int m=0;m<22;m++){
   for(int n=0;n<21;n++){
      for(int k=0;k<24;k++){
         c[m*21+n]+=a[m*24+k]*b[k*21+n];
      }
   }
}
#endif
