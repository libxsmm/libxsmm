...
void smm_dnn_12_18_24(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb19 = _MM512_MASK_LOADU_PD(&b[342+0],255);
 xb20 = _MM512_MASK_LOADU_PD(&b[360+0],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[378+0],255);
 xb22 = _MM512_MASK_LOADU_PD(&b[396+0],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[414+0],255);
for(i=0;i<12;i+=1){
 ...
 xb19 = _MM512_MASK_LOADU_PD(&b[342+8],255);
 xb20 = _MM512_MASK_LOADU_PD(&b[360+8],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[378+8],255);
 xb22 = _MM512_MASK_LOADU_PD(&b[396+8],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[414+8],255);
for(i=0;i<12;i+=1){
 ...
 xb19 = _MM512_MASK_LOADU_PD(&b[342+16],3);
 xb20 = _MM512_MASK_LOADU_PD(&b[360+16],3);
 xb21 = _MM512_MASK_LOADU_PD(&b[378+16],3);
 xb22 = _MM512_MASK_LOADU_PD(&b[396+16],3);
 xb23 = _MM512_MASK_LOADU_PD(&b[414+16],3);
for(i=0;i<12;i+=1){
...
#else
printf("cppgemm_2_12_24_18\n");
for(int m=0;m<12;m++){
   for(int n=0;n<18;n++){
      for(int k=0;k<24;k++){
         c[m*18+n]+=a[m*24+k]*b[k*18+n];
      }
   }
}
#endif
