...
void smm_dnn_12_11_22(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb15 = _MM512_MASK_LOADU_PD(&b[165+0],255);
 xb16 = _MM512_MASK_LOADU_PD(&b[176+0],255);
 xb17 = _MM512_MASK_LOADU_PD(&b[187+0],255);
 xb18 = _MM512_MASK_LOADU_PD(&b[198+0],255);
 xb19 = _MM512_MASK_LOADU_PD(&b[209+0],255);
 xb20 = _MM512_MASK_LOADU_PD(&b[220+0],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[231+0],255);
for(i=0;i<12;i+=1){
 ...
 xb15 = _MM512_MASK_LOADU_PD(&b[165+8],7);
 xb16 = _MM512_MASK_LOADU_PD(&b[176+8],7);
 xb17 = _MM512_MASK_LOADU_PD(&b[187+8],7);
 xb18 = _MM512_MASK_LOADU_PD(&b[198+8],7);
 xb19 = _MM512_MASK_LOADU_PD(&b[209+8],7);
 xb20 = _MM512_MASK_LOADU_PD(&b[220+8],7);
 xb21 = _MM512_MASK_LOADU_PD(&b[231+8],7);
for(i=0;i<12;i+=1){
...
#else
printf("cppgemm_2_12_22_11\n");
for(int m=0;m<12;m++){
   for(int n=0;n<11;n++){
      for(int k=0;k<22;k++){
         c[m*11+n]+=a[m*22+k]*b[k*11+n];
      }
   }
}
#endif
