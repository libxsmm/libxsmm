...
* 2nd byte
* 15 M (Map bit, 0F, 0F38, 0F3A and future map5, map6)
* 14 M (Map bit, 0F, 0F38, 0F3A and future map5, map6)
* 13 M (Map bit, 0F, 0F38, 0F3A and future map5, map6)
* 12 M (Map bit, 0F, 0F38, 0F3A and future map5, map6)
...
/* AVX1,AVX2,AVX512 */
#define LIBXSMM_X86_INSTR_VMOVAPD        0x20851628 /* EVEX.512.66.0F.W1 28 /r */
...
#define LIBXSMM_X86_INSTR_VMOVDQA32      10029 /*0x2005166f*/
#define LIBXSMM_X86_INSTR_VMOVDQA64      10030 /*0x2085166f*/
#define LIBXSMM_X86_INSTR_VMOVDQU8       10031 /*0x2007166f*/
#define LIBXSMM_X86_INSTR_VMOVDQU16      10032 /*0x2087166f*/
#define LIBXSMM_X86_INSTR_VMOVDQU32      10033 /*0x2006166f*/
#define LIBXSMM_X86_INSTR_VMOVDQU64      10034 /*0x2086166f*/
...
#define LIBXSMM_X86_INSTR_VMOVNTPD       10037 /*0x2085162b*/
#define LIBXSMM_X86_INSTR_VMOVNTPS       10038 /*0x2004162b*/
#define LIBXSMM_X86_INSTR_VMOVNTDQ       10039 /*0x200516e7*/
...
#define LIBXSMM_X86_INSTR_VSHUFPS        0x300c16c6 /* EVEX.512.0F.W0 C6 /r ib */
...
#define LIBXSMM_X86_INSTR_VRANGEPS    20001       /* EVEX.NDS.512.66.0F3A.W0 50 /r ib: 0F3A - W0/66 - 50 */
/* 2arg op codes */
#define LIBXSMM_X86_INSTR_VRCP14PS    0x2005264c  /* 0F38 - W1/66 - 4C */
/* 2arg op codes with imm8 */
#define LIBXSMM_X86_INSTR_VRNDSCALEPS 20002       /* 0F3A - W0/66 - 08 */

#define LIBXSMM_X86_INSTR_VXORPD      0x30851657  /* EVEX.512.66.0F.W1 57 */
#define LIBXSMM_X86_INSTR_VADDPD      0x30851658
#define LIBXSMM_X86_INSTR_VMULPD      0x30851659  /* EVEX.512.66.OF.W1 59 */
#define LIBXSMM_X86_INSTR_VSUBPD      0x3085165c
#define LIBXSMM_X86_INSTR_VADDSD      0x30871558
#define LIBXSMM_X86_INSTR_VMULSD      0x30871559  /* EVEX.LIG.F2.0F.W1 59 */
#define LIBXSMM_X86_INSTR_VSUBSD      0x3087155c
#define LIBXSMM_X86_INSTR_VXORPS      0x30041657  /* EVEX.512.0F.W0 57 */
...
#define LIBXSMM_X86_INSTR_VMULSS      0x30061459  /* EVEX.LIG.F3.OF.W0 59 */
...
#define LIBXSMM_X86_INSTR_VUNPCKLPD      0x30851614  /* EVEX.512.66.0F.W1 14 */
#define LIBXSMM_X86_INSTR_VUNPCKLPS      0x30041614  /* EVEX.512.0F.W0 14 */
#define LIBXSMM_X86_INSTR_VUNPCKHPD      0x30851615
#define LIBXSMM_X86_INSTR_VUNPCKHPS      0x30041615
#define LIBXSMM_X86_INSTR_VPSRAVD        20091       /*0x30052646*/
...
#define LIBXSMM_X86_INSTR_VMAXPS         0x3004165f /* EVEX.512.0F.W0 5F /r */
#define LIBXSMM_X86_INSTR_VCVTPS2PH      20102
#define LIBXSMM_X86_INSTR_VCVTPH2PS      20103      /* 0x20052513 */
...
#define LIBXSMM_X86_INSTR_VPERMT2W       20116      /* 0x3085267d */
#define LIBXSMM_X86_INSTR_VPMOVSXWD      20117      /* 0x20052523 */
#define LIBXSMM_X86_INSTR_VPMOVDB        20118
#define LIBXSMM_X86_INSTR_VPMOVSDB       20119
#define LIBXSMM_X86_INSTR_VPMOVUSDB      20120
#define LIBXSMM_X86_INSTR_VCVTPS2DQ      20121      /* 0x2005165b */
#define LIBXSMM_X86_INSTR_VCVTPS2UDQ     20122      /* 0x20041679 */
#define LIBXSMM_X86_INSTR_VPMOVZXWD      20123      /* 0x20052533 */
#define LIBXSMM_X86_INSTR_VPMOVSXBD      20124      /* 0x20052421 */
#define LIBXSMM_X86_INSTR_VPMOVZXBD      20125      /* 0x20052431 */
#define LIBXSMM_X86_INSTR_VPBLENDMB      20126      /* 0x30052666 */
#define LIBXSMM_X86_INSTR_VPBLENDMW      20127      /* 0x30852666 */
#define LIBXSMM_X86_INSTR_VPMAXSD        20128      /* 0x3005263d */
#define LIBXSMM_X86_INSTR_VPMINSD        20129      /* 0x30052639 */
...
/* AVX512 BF16 */
#define LIBXSMM_X86_INSTR_VDPBF16PS      0x30062652 /* EVEX.512.F3.0F38.W0 52 /r*/
