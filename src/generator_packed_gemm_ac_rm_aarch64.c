...
LIBXSMM_API_INTERN void libxsmm_generator_packed_gemm_ac_rm_aarch64_kloop( libxsmm_generated_code*            io_generated_code,
  ...
  if ( i_xgemm_desc->n != i_n_blocking ) {
    ...
    libxsmm_aarch64_instruction_alu_compute_imm12( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_ADD_I,
                                                   ...
                                                   i_n_blocking * i_micro_kernel_config->datatype_size, 0 );
...
LIBXSMM_API_INTERN void libxsmm_generator_packed_gemm_ac_rm_aarch64_kloop_simd_packed( libxsmm_generated_code*            io_generated_code,
  ...
  if ( l_use_masking ) {
    ...
    libxsmm_aarch64_instruction_asimd_move( io_generated_code, LIBXSMM_AARCH64_INSTR_ASIMD_LDR_I_POST,
                                            i_gp_reg_mapping->gp_reg_a, LIBXSMM_AARCH64_GP_REG_UNDEF, i_packed_width*i_micro_kernel_config->datatype_size,
  ...
  for ( l_n = 0; l_n < i_n_blocking; ++l_n ) {
    /* broadcast load B */
    libxsmm_aarch64_instruction_asimd_move( io_generated_code, LIBXSMM_AARCH64_INSTR_ASIMD_LDR_I_POST,
                                            i_gp_reg_mapping->gp_reg_b, LIBXSMM_AARCH64_GP_REG_UNDEF, i_micro_kernel_config->datatype_size,
                                            i_n_blocking+1, (i_micro_kernel_config->datatype_size == 4) ?  LIBXSMM_AARCH64_ASIMD_WIDTH_S : LIBXSMM_AARCH64_ASIMD_WIDTH_D );
  ...
  libxsmm_aarch64_instruction_alu_set_i64( io_generated_code, i_gp_reg_mapping->gp_reg_help_1,
                                           (unsigned long long)((i_xgemm_desc->ldb * i_micro_kernel_config->datatype_size)
  ...
  libxsmm_aarch64_instruction_alu_set_i64( io_generated_code, i_gp_reg_mapping->gp_reg_help_0,
                                           (unsigned long long)(i_xgemm_desc->k * i_packed_width* i_micro_kernel_config->datatype_size) );
  libxsmm_aarch64_instruction_alu_compute_shifted_reg( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_SUB_SR,
  ...
  /* reset B Pointer */
  libxsmm_aarch64_instruction_alu_set_i64( io_generated_code, i_gp_reg_mapping->gp_reg_help_1,
                                           (unsigned long long)(i_xgemm_desc->k * i_xgemm_desc->ldb * i_micro_kernel_config->datatype_size) );
  libxsmm_aarch64_instruction_alu_compute_shifted_reg( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_SUB_SR,
                                                       i_gp_reg_mapping->gp_reg_b, i_gp_reg_mapping->gp_reg_help_1, i_gp_reg_mapping->gp_reg_b,
                                                       0, LIBXSMM_AARCH64_SHIFTMODE_LSL );
}
