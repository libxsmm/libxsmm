...
void libxsmm_generator_vcvtneps2int_avx512( libxsmm_generated_code* io_generated_code,
  ...
  if ( i_datatype == LIBXSMM_DATATYPE_I16S ) {
    /* @TODO: add rouding */
  ...
  } else if ( i_datatype == LIBXSMM_DATATYPE_I32S ) {
    /* nothing to do */
  } else {
...
void libxsmm_generator_initialize_avx512_mask( libxsmm_generated_code* io_generated_code,
  ...
  if ( (io_generated_code->arch >= LIBXSMM_X86_AVX512) && (io_generated_code->arch <= LIBXSMM_X86_ALLFEAT) ) {
    if ( i_datatype == LIBXSMM_DATATYPE_F64 || i_datatype == LIBXSMM_DATATYPE_I64S ) {
      l_mask = 0xff;
    } else if ( i_datatype == LIBXSMM_DATATYPE_F32 || i_datatype == LIBXSMM_DATATYPE_I32S ) {
      l_mask = 0xffff;
    } else if ( i_datatype == LIBXSMM_DATATYPE_F16 || i_datatype == LIBXSMM_DATATYPE_BF16 || i_datatype == LIBXSMM_DATATYPE_I16S ) {
      l_mask = 0xffffffff;
