...
void libxsmm_generator_transform_norm_to_vnni4_aarch64_asimd_Nmod4_Mmod8_microkernel( libxsmm_generated_code*                 io_generated_code,
  ...
  libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_SUB,
                                                 i_gp_reg_in, i_gp_reg_scratch, i_gp_reg_in,  (long long)(3 * i_mateltwise_desc->ldi - 8 ) * i_micro_kernel_config->datatype_size_in );
  ...
  if (4 * i_mateltwise_desc->ldi > i_mateltwise_desc->m) {
    libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_ADD,
                                                   i_gp_reg_in, i_gp_reg_scratch, i_gp_reg_in, (long long)(4 * i_mateltwise_desc->ldi - i_mateltwise_desc->m) * i_micro_kernel_config->datatype_size_in );
  }
  if (i_mateltwise_desc->ldo > i_mateltwise_desc->m) {
    libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_ADD,
                                                   i_gp_reg_out, i_gp_reg_scratch, i_gp_reg_out, (long long)(i_mateltwise_desc->ldo  - i_mateltwise_desc->m) * 4 * i_micro_kernel_config->datatype_size_out );
  }
  /* close n loop */
...
void libxsmm_generator_transform_norm_to_vnni4_aarch64_sve_microkernel_block( libxsmm_generated_code*                 io_generated_code,
  ...
  if (i_m_remainder == 0) {
    ...
    libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_SUB,
                                                   i_gp_reg_in, i_gp_reg_scratch, i_gp_reg_in, (long long)(4 - i_n_padding_vregs) * i_mateltwise_desc->ldi * i_micro_kernel_config->datatype_size_in );
  } else {
    for (l_n = 0; l_n < 4 - i_n_padding_vregs; l_n++) {
...
void libxsmm_generator_transform_norm_to_vnni4_aarch64_sve_microkernel( libxsmm_generated_code*                 io_generated_code,
  ...
  if ( i_mateltwise_desc->m >= 16) {
    ...
    if (i_mateltwise_desc->n >= 4) {
      ...
      if ((4 * i_mateltwise_desc->ldi) > l_effective_m) {
        libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_ADD,
                                                     i_gp_reg_in, i_gp_reg_scratch, i_gp_reg_in, (long long)(4 * i_mateltwise_desc->ldi - l_effective_m) * i_micro_kernel_config->datatype_size_in );
      }

      if (i_mateltwise_desc->ldo > l_effective_m) {
        libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_ADD,
                                                     i_gp_reg_out, i_gp_reg_scratch, i_gp_reg_out, (long long)(4 * i_mateltwise_desc->ldo  - l_effective_m * 4) * i_micro_kernel_config->datatype_size_out );
      }
      /* close n loop */
      libxsmm_generator_loop_footer_aarch64( io_generated_code, io_loop_label_tracker, i_gp_reg_n_loop, 4 );
    }
  ...
  if (l_m_remainder > 0) {
    ...
    if (i_mateltwise_desc->n >= 4) {
      ...
      libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_ADD,
                                                   i_gp_reg_in, i_gp_reg_scratch, i_gp_reg_in,  (long long)(4 *i_mateltwise_desc->ldi ) * i_micro_kernel_config->datatype_size_in );

      libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_ADD,
                                                   i_gp_reg_out, i_gp_reg_scratch, i_gp_reg_out, (long long)(4 *i_mateltwise_desc->ldo ) * i_micro_kernel_config->datatype_size_out );
      /* close n loop */
      libxsmm_generator_loop_footer_aarch64( io_generated_code, io_loop_label_tracker, i_gp_reg_n_loop, 4 );
    }
    if (l_n_remainder != 0) {
...
void libxsmm_generator_transform_norm_to_vnni4_mbit_scalar_aarch64_asimd_microkernel( libxsmm_generated_code*                 io_generated_code,
  ...
  if ( i_mateltwise_desc->n >= 4 ) {
    ...
    libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_SUB,
                                                   i_gp_reg_in, i_gp_reg_scratch, i_gp_reg_in,
                                                   (long long)(3 * i_mateltwise_desc->ldi - 1) * i_micro_kernel_config->datatype_size_in );
...
void libxsmm_generator_transform_vnni4_to_vnni4t_Nmod16_16bit_aarch64_asimd_microkernel(  libxsmm_generated_code*                 io_generated_code,
  ...
  libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_ADD,
                                                 i_gp_reg_in, i_gp_reg_scratch, i_gp_reg_in,  (long long)(4 * l_ldi - 4 * i_mateltwise_desc->m) * i_micro_kernel_config->datatype_size_in );

  libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_SUB,
                                                 i_gp_reg_out, i_gp_reg_scratch, i_gp_reg_out, (long long)(l_ldo * (i_mateltwise_desc->m/4) - 16 * 4) * i_micro_kernel_config->datatype_size_out );
...
void libxsmm_generator_transform_vnni4_to_vnni4t_Nmod16_16bit_aarch64_sve_microkernel(  libxsmm_generated_code*                 io_generated_code,
  ...
  libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_SUB,
                                                 i_gp_reg_in, i_gp_reg_scratch, i_gp_reg_in,  (long long)(3 * l_ldi - 16) * i_micro_kernel_config->datatype_size_in );
