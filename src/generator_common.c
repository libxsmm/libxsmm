...
LIBXSMM_API_INTERN libxsmm_meltw_comp_flags libxsmm_get_meltw_comp_flags( libxsmm_meltw_flags flags )
{
  switch ( flags ) {
    ...
    case LIBXSMM_MELTW_FLAG_ACT_RELU:
      return LIBXSMM_MELTW_COMP_FLAG_ACT_RELU;
    case LIBXSMM_MELTW_FLAG_ACT_TANH:
      return LIBXSMM_MELTW_COMP_FLAG_ACT_TANH;
    case LIBXSMM_MELTW_FLAG_ACT_SIGM:
      return LIBXSMM_MELTW_COMP_FLAG_ACT_SIGM;
    case LIBXSMM_MELTW_FLAG_ACT_GELU:
      return LIBXSMM_MELTW_COMP_FLAG_ACT_GELU;
    case LIBXSMM_MELTW_FLAG_OVERWRITE_C:
      return LIBXSMM_MELTW_COMP_FLAG_OVERWRITE_C;
    case LIBXSMM_MELTW_FLAG_COLBIAS_OVERWRITE_C:
      return LIBXSMM_MELTW_COMP_FLAG_COLBIAS_OVERWRITE_C;
    case LIBXSMM_MELTW_FLAG_ACT_RELU_OVERWRITE_C:
      return LIBXSMM_MELTW_COMP_FLAG_ACT_RELU_OVERWRITE_C;
    case LIBXSMM_MELTW_FLAG_ACT_TANH_OVERWRITE_C:
      return LIBXSMM_MELTW_COMP_FLAG_ACT_TANH_OVERWRITE_C;
    case LIBXSMM_MELTW_FLAG_ACT_SIGM_OVERWRITE_C:
      return LIBXSMM_MELTW_COMP_FLAG_ACT_SIGM_OVERWRITE_C;
    case LIBXSMM_MELTW_FLAG_ACT_GELU_OVERWRITE_C:
      return LIBXSMM_MELTW_COMP_FLAG_ACT_GELU_OVERWRITE_C;
    case LIBXSMM_MELTW_FLAG_COLBIAS_ACT_RELU:
      return LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_RELU;
    case LIBXSMM_MELTW_FLAG_COLBIAS_ACT_TANH:
      return LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_TANH;
    case LIBXSMM_MELTW_FLAG_COLBIAS_ACT_SIGM:
      return LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_SIGM;
    case LIBXSMM_MELTW_FLAG_COLBIAS_ACT_GELU:
      return LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_GELU;
    case LIBXSMM_MELTW_FLAG_COLBIAS_ACT_RELU_OVERWRITE_C:
      return LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_RELU_OVERWRITE_C;
    case LIBXSMM_MELTW_FLAG_COLBIAS_ACT_TANH_OVERWRITE_C:
      return LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_TANH_OVERWRITE_C;
    case LIBXSMM_MELTW_FLAG_COLBIAS_ACT_SIGM_OVERWRITE_C:
      return LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_SIGM_OVERWRITE_C;
    case LIBXSMM_MELTW_FLAG_COLBIAS_ACT_GELU_OVERWRITE_C:
      return LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_GELU_OVERWRITE_C;
    default:
      return LIBXSMM_MELTW_COMP_FLAG_NONE;
  }
}
...
LIBXSMM_API_INTERN libxsmm_meltw_flags libxsmm_get_meltw_flags( libxsmm_meltw_comp_flags flags )
{
  switch ( flags ) {
    ...
    case LIBXSMM_MELTW_COMP_FLAG_ACT_RELU:
      return LIBXSMM_MELTW_FLAG_ACT_RELU;
    case LIBXSMM_MELTW_COMP_FLAG_ACT_TANH:
      return LIBXSMM_MELTW_FLAG_ACT_TANH;
    case LIBXSMM_MELTW_COMP_FLAG_ACT_SIGM:
      return LIBXSMM_MELTW_FLAG_ACT_SIGM;
    case LIBXSMM_MELTW_COMP_FLAG_ACT_GELU:
      return LIBXSMM_MELTW_FLAG_ACT_GELU;
    case LIBXSMM_MELTW_COMP_FLAG_OVERWRITE_C:
      return LIBXSMM_MELTW_FLAG_OVERWRITE_C;
    case LIBXSMM_MELTW_COMP_FLAG_COLBIAS_OVERWRITE_C:
      return LIBXSMM_MELTW_FLAG_COLBIAS_OVERWRITE_C;
    case LIBXSMM_MELTW_COMP_FLAG_ACT_RELU_OVERWRITE_C:
      return LIBXSMM_MELTW_FLAG_ACT_RELU_OVERWRITE_C;
    case LIBXSMM_MELTW_COMP_FLAG_ACT_TANH_OVERWRITE_C:
      return LIBXSMM_MELTW_FLAG_ACT_TANH_OVERWRITE_C;
    case LIBXSMM_MELTW_COMP_FLAG_ACT_SIGM_OVERWRITE_C:
      return LIBXSMM_MELTW_FLAG_ACT_SIGM_OVERWRITE_C;
    case LIBXSMM_MELTW_COMP_FLAG_ACT_GELU_OVERWRITE_C:
      return LIBXSMM_MELTW_FLAG_ACT_GELU_OVERWRITE_C;
    case LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_RELU:
      return LIBXSMM_MELTW_FLAG_COLBIAS_ACT_RELU;
    case LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_TANH:
      return LIBXSMM_MELTW_FLAG_COLBIAS_ACT_TANH;
    case LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_SIGM:
      return LIBXSMM_MELTW_FLAG_COLBIAS_ACT_SIGM;
    case LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_GELU:
      return LIBXSMM_MELTW_FLAG_COLBIAS_ACT_GELU;
    case LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_RELU_OVERWRITE_C:
      return LIBXSMM_MELTW_FLAG_COLBIAS_ACT_RELU_OVERWRITE_C;
    case LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_TANH_OVERWRITE_C:
      return LIBXSMM_MELTW_FLAG_COLBIAS_ACT_TANH_OVERWRITE_C;
    case LIBXSMM_MELTW_COMP_FLAG_COLBIAS_ACT_SIGM_OVERWRITE_C:
      return LIBXSMM_MELTW_FLAG_COLBIAS_ACT_SIGM_OVERWRITE_C;
