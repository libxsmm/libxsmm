...
LIBXSMM_API_INTERN
void libxsmm_generator_packed_gemm_bc_rm_aarch64( libxsmm_generated_code*         io_generated_code,
  ...
  /* TODO: we could do more aggressive blocking if needed */
  l_max_reg_block = 28;
  ...
  if ( l_n1_block == i_xgemm_desc->n ) {
    /* no N loop at all */
    libxsmm_generator_packed_gemm_bc_rm_aarch64_kloop( io_generated_code, &l_loop_label_tracker, &l_gp_reg_mapping, &l_micro_kernel_config, i_xgemm_desc,
    ...
    libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_SUB,
                                                   ...
                                                   (long long)i_xgemm_desc->n * i_packed_width * l_micro_kernel_config.datatype_size_in );
    libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_SUB,
  ...
  libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_ADD,
                                                 ...
                                                 (long long)l_micro_kernel_config.datatype_size_in*i_xgemm_desc->lda );
  /* advance C pointer */
  libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_ADD,
                                                 l_gp_reg_mapping.gp_reg_c, l_gp_reg_mapping.gp_reg_help_2, l_gp_reg_mapping.gp_reg_c,
...
LIBXSMM_API_INTERN
void libxsmm_generator_packed_gemm_bc_rm_aarch64_kloop( libxsmm_generated_code*            io_generated_code,
  ...
  if ( (io_generated_code->arch >= LIBXSMM_AARCH64_SVE128) && (io_generated_code->arch <= LIBXSMM_AARCH64_ALLFEAT) ) {
    l_generator_microkernel = libxsmm_generator_packed_gemm_bc_rm_aarch64_kloop_simd_packed_sve;
  } else {
    l_generator_microkernel = libxsmm_generator_packed_gemm_bc_rm_aarch64_kloop_simd_packed_asimd;
  }
  ...
  if ( i_xgemm_desc->n != i_n_blocking ) {
    ...
    libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_ADD,
                                                   i_gp_reg_mapping->gp_reg_b, i_gp_reg_mapping->gp_reg_help_1, i_gp_reg_mapping->gp_reg_b,
                                                   (long long)i_n_blocking * i_packed_width * i_micro_kernel_config->datatype_size_in );
...
LIBXSMM_API_INTERN
void libxsmm_generator_packed_gemm_bc_rm_aarch64_kloop_simd_packed_asimd( libxsmm_generated_code*            io_generated_code,
                                                                          libxsmm_loop_label_tracker*        io_loop_label_tracker,
                                                                          const libxsmm_gp_reg_mapping*      i_gp_reg_mapping,
                                                                          const libxsmm_micro_kernel_config* i_micro_kernel_config,
                                                                          const libxsmm_gemm_descriptor*     i_xgemm_desc,
  ...
  libxsmm_aarch64_instruction_asimd_move( io_generated_code, LIBXSMM_AARCH64_INSTR_ASIMD_LDR_I_POST,
                                          ...
                                          i_n_blocking, (i_micro_kernel_config->datatype_size_in == 4) ?  LIBXSMM_AARCH64_ASIMD_WIDTH_S : LIBXSMM_AARCH64_ASIMD_WIDTH_D );
  ...
  for ( l_n = 0; l_n < i_n_blocking; ++l_n ) {
    if ( l_use_masking ) {
      ...
      libxsmm_aarch64_instruction_asimd_move( io_generated_code, LIBXSMM_AARCH64_INSTR_ASIMD_LDR_I_POST,
                                              i_gp_reg_mapping->gp_reg_b, LIBXSMM_AARCH64_GP_REG_UNDEF, i_packed_width * i_micro_kernel_config->datatype_size_in,
                                              i_n_blocking+1, LIBXSMM_AARCH64_ASIMD_WIDTH_Q );
  ...
  libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_ADD,
                                                 i_gp_reg_mapping->gp_reg_b, i_gp_reg_mapping->gp_reg_help_1, i_gp_reg_mapping->gp_reg_b,
                                                 (long long)(((long long)i_packed_width * i_xgemm_desc->ldb * i_micro_kernel_config->datatype_size_in)
                                                    - ((long long)i_n_blocking * i_packed_width * i_micro_kernel_config->datatype_size_in)) );
  ...
  libxsmm_aarch64_instruction_alu_compute_imm64( io_generated_code, LIBXSMM_AARCH64_INSTR_GP_META_SUB,
                                                 i_gp_reg_mapping->gp_reg_b, i_gp_reg_mapping->gp_reg_help_1, i_gp_reg_mapping->gp_reg_b,
                                                 (long long)i_xgemm_desc->k * i_xgemm_desc->ldb * i_packed_width * i_micro_kernel_config->datatype_size_in );
}

LIBXSMM_API_INTERN
void libxsmm_generator_packed_gemm_bc_rm_aarch64_kloop_simd_packed_sve( libxsmm_generated_code*            io_generated_code,
                                                                        libxsmm_loop_label_tracker*        io_loop_label_tracker,
                                                                        const libxsmm_gp_reg_mapping*      i_gp_reg_mapping,
                                                                        const libxsmm_micro_kernel_config* i_micro_kernel_config,
                                                                        const libxsmm_gemm_descriptor*     i_xgemm_desc,
  ...
  libxsmm_aarch64_instruction_sve_move( io_generated_code,
                                        ...
                                        LIBXSMM_AARCH64_GP_REG_UNDEF, 0, i_n_blocking, LIBXSMM_AARCH64_SVE_REG_P0 );
