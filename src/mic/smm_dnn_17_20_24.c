...
void smm_dnn_17_20_24(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb23 = _MM512_MASK_LOADU_PD(&b[460+0],255);
for(i=0;i<17;i+=1){
 ...
 xb23 = _MM512_MASK_LOADU_PD(&b[460+8],255);
for(i=0;i<17;i+=1){
 ...
 xb23 = _MM512_MASK_LOADU_PD(&b[460+16],15);
for(i=0;i<17;i+=1){
...
#else
printf("cppgemm_2_17_24_20\n");
for(int m=0;m<17;m++){
   for(int n=0;n<20;n++){
      for(int k=0;k<24;k++){
         c[m*20+n]+=a[m*24+k]*b[k*20+n];
      }
   }
}
#endif
