...
void smm_dnn_18_22_24(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb17 = _MM512_MASK_LOADU_PD(&b[374+0],255);
 xb18 = _MM512_MASK_LOADU_PD(&b[396+0],255);
 xb19 = _MM512_MASK_LOADU_PD(&b[418+0],255);
 xb20 = _MM512_MASK_LOADU_PD(&b[440+0],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[462+0],255);
 xb22 = _MM512_MASK_LOADU_PD(&b[484+0],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[506+0],255);
for(i=0;i<18;i+=1){
 ...
 xb17 = _MM512_MASK_LOADU_PD(&b[374+8],255);
 xb18 = _MM512_MASK_LOADU_PD(&b[396+8],255);
 xb19 = _MM512_MASK_LOADU_PD(&b[418+8],255);
 xb20 = _MM512_MASK_LOADU_PD(&b[440+8],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[462+8],255);
 xb22 = _MM512_MASK_LOADU_PD(&b[484+8],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[506+8],255);
for(i=0;i<18;i+=1){
 ...
 xb17 = _MM512_MASK_LOADU_PD(&b[374+16],63);
 xb18 = _MM512_MASK_LOADU_PD(&b[396+16],63);
 xb19 = _MM512_MASK_LOADU_PD(&b[418+16],63);
 xb20 = _MM512_MASK_LOADU_PD(&b[440+16],63);
 xb21 = _MM512_MASK_LOADU_PD(&b[462+16],63);
 xb22 = _MM512_MASK_LOADU_PD(&b[484+16],63);
 xb23 = _MM512_MASK_LOADU_PD(&b[506+16],63);
for(i=0;i<18;i+=1){
...
#else
printf("cppgemm_2_18_24_22\n");
for(int m=0;m<18;m++){
   for(int n=0;n<22;n++){
      for(int k=0;k<24;k++){
         c[m*22+n]+=a[m*24+k]*b[k*22+n];
      }
   }
}
#endif
