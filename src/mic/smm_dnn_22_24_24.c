...
void smm_dnn_22_24_24(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb23 = _MM512_MASK_LOADU_PD(&b[552+0],255);
for(i=0;i<22;i+=1){
 ...
 xb23 = _MM512_MASK_LOADU_PD(&b[552+8],255);
for(i=0;i<22;i+=1){
 ...
 xb23 = _MM512_MASK_LOADU_PD(&b[552+16],255);
for(i=0;i<22;i+=1){
...
#else
printf("cppgemm_2_22_24_24\n");
for(int m=0;m<22;m++){
   for(int n=0;n<24;n++){
      for(int k=0;k<24;k++){
         c[m*24+n]+=a[m*24+k]*b[k*24+n];
      }
   }
}
#endif
