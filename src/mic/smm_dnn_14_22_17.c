...
void smm_dnn_14_22_17(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb14 = _MM512_MASK_LOADU_PD(&b[308+0],255);
 xb15 = _MM512_MASK_LOADU_PD(&b[330+0],255);
 xb16 = _MM512_MASK_LOADU_PD(&b[352+0],255);
for(i=0;i<14;i+=1){
 ...
 xb14 = _MM512_MASK_LOADU_PD(&b[308+8],255);
 xb15 = _MM512_MASK_LOADU_PD(&b[330+8],255);
 xb16 = _MM512_MASK_LOADU_PD(&b[352+8],255);
for(i=0;i<14;i+=1){
 ...
 xb14 = _MM512_MASK_LOADU_PD(&b[308+16],63);
 xb15 = _MM512_MASK_LOADU_PD(&b[330+16],63);
 xb16 = _MM512_MASK_LOADU_PD(&b[352+16],63);
for(i=0;i<14;i+=1){
...
#else
printf("cppgemm_2_14_17_22\n");
for(int m=0;m<14;m++){
   for(int n=0;n<22;n++){
      for(int k=0;k<17;k++){
         c[m*22+n]+=a[m*17+k]*b[k*22+n];
      }
   }
}
#endif
