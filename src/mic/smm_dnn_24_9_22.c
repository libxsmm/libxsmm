...
void smm_dnn_24_9_22(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb18 = _MM512_MASK_LOADU_PD(&b[162+0],255);
 xb19 = _MM512_MASK_LOADU_PD(&b[171+0],255);
 xb20 = _MM512_MASK_LOADU_PD(&b[180+0],255);
 xb21 = _MM512_MASK_LOADU_PD(&b[189+0],255);
for(i=0;i<24;i+=1){
 ...
 xb18 = _MM512_MASK_LOADU_PD(&b[162+8],1);
 xb19 = _MM512_MASK_LOADU_PD(&b[171+8],1);
 xb20 = _MM512_MASK_LOADU_PD(&b[180+8],1);
 xb21 = _MM512_MASK_LOADU_PD(&b[189+8],1);
for(i=0;i<24;i+=1){
...
#else
printf("cppgemm_2_24_22_9\n");
for(int m=0;m<24;m++){
   for(int n=0;n<9;n++){
      for(int k=0;k<22;k++){
         c[m*9+n]+=a[m*22+k]*b[k*9+n];
      }
   }
}
#endif
