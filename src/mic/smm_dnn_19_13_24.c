...
void smm_dnn_19_13_24(const double* a, const double* b, double* c){
#ifdef __MIC__
int i;
__m512d xa0;
__m512d xa1;
...
__m512d xc0;
 ...
 xb22 = _MM512_MASK_LOADU_PD(&b[286+0],255);
 xb23 = _MM512_MASK_LOADU_PD(&b[299+0],255);
for(i=0;i<19;i+=1){
 ...
 xb22 = _MM512_MASK_LOADU_PD(&b[286+8],31);
 xb23 = _MM512_MASK_LOADU_PD(&b[299+8],31);
for(i=0;i<19;i+=1){
...
#else
printf("cppgemm_2_19_24_13\n");
for(int m=0;m<19;m++){
   for(int n=0;n<13;n++){
      for(int k=0;k<24;k++){
         c[m*13+n]+=a[m*24+k]*b[k*13+n];
      }
   }
}
#endif
