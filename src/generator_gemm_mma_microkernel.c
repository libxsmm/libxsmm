...
LIBXSMM_API_INTERN
void libxsmm_generator_gemm_mma_mk_load_trans( libxsmm_generated_code   *io_generated_code,
                                               libxsmm_ppc64le_reg      *io_reg_tracker,
...
LIBXSMM_API_INTERN
void libxsmm_generator_gemm_mma_mk_load_acc( libxsmm_generated_code *io_generated_code,
                                             libxsmm_ppc64le_reg    *io_reg_tracker,
                                             libxsmm_datatype const  i_datatype,
                                             libxsmm_datatype const  i_comptype,
                                             unsigned int const      i_a,
...
LIBXSMM_API_INTERN
void libxsmm_generator_gemm_mma_mk_store_acc( libxsmm_generated_code *io_generated_code,
                                              libxsmm_ppc64le_reg    *io_reg_tracker,
                                              libxsmm_datatype const  i_datatype,
                                              libxsmm_datatype const  i_comptype,
                                              unsigned int const      i_a,
...
void libxsmm_generator_mma_microkernel( libxsmm_generated_code        *io_generated_code,
  ...
  for ( unsigned int l_k_block = 0; l_k_block < l_n_k_blocks; ++l_k_block ) {
    ...
    libxsmm_generator_gemm_mma_mk_load_trans( io_generated_code,
                                              io_reg_tracker,
                                              l_b_datatype,
                                              l_comptype,
                                              l_b,
  ...
  /* Store blocks of C */
  libxsmm_generator_gemm_mma_mk_store_acc( io_generated_code,
                                           io_reg_tracker,
                                           l_c_datatype,
                                           l_comptype,
                                           i_c,
