  ...
  if (i_is_Ai8_Bf16_gemm > 0) {
    if (l_is_Ai4_Bf16_gemm > 0) {
      ...
      if (i_use_f32_compute_with_f16_inp > 0 || i_use_f16_replacement_fma > 0) {
        ...
        if (l_subtract_zpt > 0) {
          libxsmm_x86_instruction_vec_compute_3reg( io_generated_code, LIBXSMM_X86_INSTR_VPSUBD, i_micro_kernel_config->vector_name, l_vec_zpt_a, tmp_hi_vreg, tmp_hi_vreg);
        }
        ...
        if (l_subtract_zpt > 0) {
          libxsmm_x86_instruction_vec_compute_3reg( io_generated_code, LIBXSMM_X86_INSTR_VPSUBD, i_micro_kernel_config->vector_name, l_vec_zpt_a, tmp_lo_vreg, tmp_lo_vreg);
        }
        ...
        if (l_subtract_zpt > 0) {
          libxsmm_x86_instruction_vec_compute_3reg( io_generated_code, LIBXSMM_X86_INSTR_VPSUBW, i_micro_kernel_config->vector_name, l_vec_zpt_a, tmp_hi_vreg, tmp_hi_vreg);
        }
        ...
        if (l_subtract_zpt > 0) {
          libxsmm_x86_instruction_vec_compute_3reg( io_generated_code, LIBXSMM_X86_INSTR_VPSUBW, i_micro_kernel_config->vector_name, l_vec_zpt_a, tmp_lo_vreg, tmp_lo_vreg);
        }
