                                                 ...
                                                 const unsigned int                 i_k_blocking )
{
  ...
  unsigned int l_is_last_k_microkernel = i_micro_kernel_config->is_last_k_microkernel;
  ...
  if ( ( io_generated_code->arch >= LIBXSMM_X86_AVX512_VL256 ) && ( l_m_vector == 1 ) && (l_is_Ai8_Bbf16_gemm == 0) && ( LIBXSMM_DATATYPE_BF8 != LIBXSMM_GEMM_GETENUM_AB_COMMON_PREC( i_xgemm_desc->datatype ) ) ) {
    ...
    for ( l_k = 0; l_k < i_k_blocking; l_k += l_k_pack_factor) {
      if (l_is_Ai8_Bbf16_gemm > 0) {
        i_micro_kernel_config->is_last_k_microkernel = ((l_is_last_k_microkernel > 0) && ((l_k + l_k_pack_factor) >= i_k_blocking)) ? 1 : 0;
      }
...
LIBXSMM_API_INTERN void libxsmm_generator_gemm_avx512_microkernel_loadNinterleave_A_pair_k_i8_to_bf16( libxsmm_generated_code*            io_generated_code,
  ...
  if (l_is_Ai8_Bbf16_gemm_bf16fma > 0) {
    if ((i_micro_kernel_config->is_last_k_microkernel == 1) && (i_xgemm_desc->k % 2 != 0)) {
      libxsmm_x86_instruction_vec_compute_3reg( io_generated_code, i_micro_kernel_config->vxor_instruction, i_micro_kernel_config->vector_name, i_tmp_vreg, i_tmp_vreg, i_tmp_vreg );
    } else {
      /* Load "odd" k  */
      libxsmm_x86_instruction_vec_move( io_generated_code,
          i_micro_kernel_config->instruction_set,
  ...
  if (l_is_Ai8_Bbf16_gemm_bf16fma > 0) {
    ...
    libxsmm_x86_instruction_vec_compute_2reg( io_generated_code, LIBXSMM_X86_INSTR_VPMOVSXWD, i_micro_kernel_config->vector_name, io_A_vreg, io_A_vreg);
                                                                             ...
                                                                             const int                          i_offset )
{
  ...
  for ( l_m = 0; l_m < l_m_blocking; l_m++ ) {
    ...
    libxsmm_generator_gemm_avx512_microkernel_process_vreg_A( io_generated_code, i_micro_kernel_config, i_xgemm_desc,
        vname_cvt, l_is_Ai8_Bf16_gemm, l_is_Af16_Bf16_gemm, l_use_f16_replacement_fma, l_use_f32_compute_with_f16_inp, l_m, 1+l_m+l_vreg_ab_offset);
  ...
  for ( l_n = 0; l_n < i_n_blocking; l_n++ ) {
    ...
    if (l_is_Ai8_Bbf16_gemm > 0) {
      if (((i_micro_kernel_config->is_last_k_microkernel > 0) && ((i_xgemm_desc->k % 2) != 0)) || (l_is_Ai8_Bbf16_gemm_bf16fma == 0)) {
    ...
    if ( i_offset != (-1) ) {
      ...
      /* handle trans B */
      if ( (i_xgemm_desc->flags & LIBXSMM_GEMM_FLAG_TRANS_B) > 0 ) {
        unsigned int l_k_pack_advance = (l_is_Ai8_Bbf16_gemm > 0) ? ((((i_micro_kernel_config->is_last_k_microkernel > 0) && (i_xgemm_desc->k % 2 != 0)) || (l_is_Ai8_Bbf16_gemm_bf16fma == 0)) ? 1 : 2) : l_k_pack_factor;
      ...
      if (l_n == i_n_blocking - 1) {
        ...
        if ( (i_xgemm_desc->flags & LIBXSMM_GEMM_FLAG_TRANS_B) > 0 ) {
          ...
          unsigned int l_k_pack_advance = (l_is_Ai8_Bbf16_gemm > 0) ? ((((i_micro_kernel_config->is_last_k_microkernel > 0) && (i_xgemm_desc->k % 2 != 0)) || (l_is_Ai8_Bbf16_gemm_bf16fma == 0)) ? 1 : 2) : l_k_pack_factor;
          l_b_offset = i_micro_kernel_config->datatype_size_in2 * l_k_pack_advance;
        }
                                                                                ...
                                                                                const int                          i_offset )
{
  ...
  for ( l_m = 0; l_m < l_m_blocking; l_m++ ) {
    ...
    /* Process vreg A in case of f16/i8 */
    libxsmm_generator_gemm_avx512_microkernel_process_vreg_A( io_generated_code, i_micro_kernel_config, i_xgemm_desc,
        vname_cvt, l_is_Ai8_Bf16_gemm, l_is_Af16_Bf16_gemm, l_use_f16_replacement_fma, l_use_f32_compute_with_f16_inp, l_m, l_vreg_ab_offset);
                                                                           ...
                                                                           const unsigned int                 i_k_blocking )
{
  ...
  for ( l_k = 0; l_k < l_k_iters; l_k++ ) {
    if ( l_k == 0 ) {
      ...
      /* Process vreg A in case of f16/i8 */
      libxsmm_generator_gemm_avx512_microkernel_process_vreg_A( io_generated_code, i_micro_kernel_config, i_xgemm_desc,
          vname_cvt, l_is_Ai8_Bf16_gemm, l_is_Af16_Bf16_gemm, l_use_f16_replacement_fma, l_use_f32_compute_with_f16_inp, 0, l_vreg_ab_offset);
      ...
      if ( l_k_iters > 1 ) {
        ...
        /* Process vreg A in case of f16/i8 */
        libxsmm_generator_gemm_avx512_microkernel_process_vreg_A( io_generated_code, i_micro_kernel_config, i_xgemm_desc,
            vname_cvt, l_is_Ai8_Bf16_gemm, l_is_Af16_Bf16_gemm, l_use_f16_replacement_fma, l_use_f32_compute_with_f16_inp, 0, 1 + l_vreg_ab_offset);
      ...
      /* Process vreg A in case of f16/i8 */
      libxsmm_generator_gemm_avx512_microkernel_process_vreg_A( io_generated_code, i_micro_kernel_config, i_xgemm_desc,
          vname_cvt, l_is_Ai8_Bf16_gemm, l_is_Af16_Bf16_gemm, l_use_f16_replacement_fma, l_use_f32_compute_with_f16_inp, 0, (l_k+1)%2 + l_vreg_ab_offset);
