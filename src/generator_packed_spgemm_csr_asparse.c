...
LIBXSMM_API_INTERN
void libxsmm_generator_packed_spgemm_csr_asparse( libxsmm_generated_code*         io_generated_code,
  ...
  if ( (io_generated_code->arch >= LIBXSMM_X86_AVX) &&
    ...
    libxsmm_generator_packed_spgemm_csr_asparse_avx_avx2_avx512( io_generated_code,
                                                                 i_xgemm_desc,
                                                                 i_row_idx,
                                                                 i_column_idx,
                                                                 i_values,
    ...
    libxsmm_generator_packed_spgemm_csr_asparse_aarch64( io_generated_code,
                                                         i_xgemm_desc,
                                                         i_row_idx,
                                                         i_column_idx,
                                                         i_values,
