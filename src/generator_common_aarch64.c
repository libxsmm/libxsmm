...
void libxsmm_generator_prepare_coeffs_gelu_ps_minimax3_aarch64_sve( libxsmm_generated_code*               io_generated_code,
  ...
  libxsmm_aarch64_instruction_sve_load64bytes_const_to_vec( io_generated_code, LIBXSMM_CAST_UCHAR(i_vec_c0), i_gp_reg_tmp, i_gp_reg_tmp1, i_pred_reg, c0_array, 0 );
  libxsmm_aarch64_instruction_sve_load64bytes_const_to_vec( io_generated_code, LIBXSMM_CAST_UCHAR(i_vec_c1), i_gp_reg_tmp, i_gp_reg_tmp1, i_pred_reg, c1_array, 0 );
  libxsmm_aarch64_instruction_sve_load64bytes_const_to_vec( io_generated_code, LIBXSMM_CAST_UCHAR(i_vec_c2), i_gp_reg_tmp, i_gp_reg_tmp1, i_pred_reg, c2_array, 0 );
}

LIBXSMM_API_INTERN
//only works for 256 bit vector length
void libxsmm_generator_prepare_coeffs_gelu_ps_minimax3_aarch64_sve_256( libxsmm_generated_code*               io_generated_code,
  ...
  /* assumes 256 bit vector length */
  libxsmm_aarch64_instruction_sve_load32bytes_const_to_vec( io_generated_code, LIBXSMM_CAST_UCHAR(i_vec_c0),  i_gp_reg_tmp, i_gp_reg_tmp1, i_pred_reg, c0_array, 0 );
  libxsmm_aarch64_instruction_sve_load32bytes_const_to_vec( io_generated_code, LIBXSMM_CAST_UCHAR(i_vec_c01), i_gp_reg_tmp, i_gp_reg_tmp1, i_pred_reg, c0_array, 4 );
  libxsmm_aarch64_instruction_sve_load32bytes_const_to_vec( io_generated_code, LIBXSMM_CAST_UCHAR(i_vec_c1),  i_gp_reg_tmp, i_gp_reg_tmp1, i_pred_reg, c1_array, 0 );
  libxsmm_aarch64_instruction_sve_load32bytes_const_to_vec( io_generated_code, LIBXSMM_CAST_UCHAR(i_vec_c11), i_gp_reg_tmp, i_gp_reg_tmp1, i_pred_reg, c1_array, 4 );
  libxsmm_aarch64_instruction_sve_load32bytes_const_to_vec( io_generated_code, LIBXSMM_CAST_UCHAR(i_vec_c2),  i_gp_reg_tmp, i_gp_reg_tmp1, i_pred_reg, c2_array, 0 );
  libxsmm_aarch64_instruction_sve_load32bytes_const_to_vec( io_generated_code, LIBXSMM_CAST_UCHAR(i_vec_c21), i_gp_reg_tmp, i_gp_reg_tmp1, i_pred_reg, c2_array, 4 );
}
...
void libxsmm_generator_gelu_ps_minimax3_aarch64_sve_256( libxsmm_generated_code*               io_generated_code,
    ...
    /*
    * the following six TBL instructions are specific to 256 bit vector length
    */
    ...
    /*Sub vector length */
    libxsmm_aarch64_instruction_sve_compute( io_generated_code, LIBXSMM_AARCH64_INSTR_SVE_SUB_V,
                                           LIBXSMM_AARCH64_SVE_REG_UNDEF, LIBXSMM_AARCH64_SVE_REG_UNDEF, 8, i_vec_index,
                                           i_pred_reg, i_sve_type );

    libxsmm_aarch64_instruction_sve_compute( io_generated_code, LIBXSMM_AARCH64_INSTR_SVE_TBL,
                                             i_vec_c01, i_vec_index, 0, i_vec_temp,
                                             i_pred_reg, i_sve_type );
    libxsmm_aarch64_instruction_sve_compute( io_generated_code, LIBXSMM_AARCH64_INSTR_SVE_ORR_V,  /*ORR seems to be faster than FADD_V*/
