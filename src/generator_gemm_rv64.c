...
void libxsmm_generator_gemm_rv64_microkernel_rvv( libxsmm_generated_code*            io_generated_code,
  ...
  unsigned int l_b_load_instr = LIBXSMM_RV64_INSTR_UNDEF;
  unsigned int l_b_load_scalar_instr = LIBXSMM_RV64_INSTR_UNDEF;
  unsigned int l_b_load_bcast_instr = LIBXSMM_RV64_INSTR_UNDEF;
  ...
  l_b_load_instr = LIBXSMM_RV64_INSTR_GP_VRGATHER_VV;
  l_b_load_scalar_instr = LIBXSMM_RV64_INSTR_GP_FLW;
  l_b_load_bcast_instr = LIBXSMM_RV64_INSTR_GP_VFMV_V_F;
...
void libxsmm_generator_gemm_rv64_kernel( libxsmm_generated_code*        io_generated_code,
  ...
  l_gp_reg_mapping.gp_reg_a_offset = LIBXSMM_RV64_GP_REG_X6;
  l_gp_reg_mapping.gp_reg_b_offset = LIBXSMM_RV64_GP_REG_X7;
  l_gp_reg_mapping.gp_reg_help_3 = LIBXSMM_RV64_GP_REG_X5;      /* storing forward counting BRGEMM interations */
  ...
  l_gp_reg_mapping.gp_reg_reduce_loop = LIBXSMM_RV64_GP_REG_X31; /* BRGEMM loop */
  ...
  while (l_n_done != (unsigned int)l_xgemm_desc_opa->n) {
    ...
    while (l_m_done != (unsigned int)l_xgemm_desc_opa->m) {
      ...
      if (l_m_blocking != l_micro_kernel_config.vector_length){
