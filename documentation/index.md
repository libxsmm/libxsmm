...
<a name="interface-for-convolutions"></a>The function domain for Deep Neural Networks (DNN) is detailed by a separate [document](libxsmm_dnn.md). Please also note the separate guide for [Getting Started using TensorFlow&trade; and LIBXSMM](tensorflow.md).
